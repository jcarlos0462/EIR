...
if ($check->num_rows == 0) {
    ...
    // Nota: Se agrega al final de la tabla para evitar problemas de compatibilidad con diferentes
    // nombres de columnas (CodSeveridadDano vs SeveridadID). La posición no afecta la funcionalidad.
